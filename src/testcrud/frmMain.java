...
public class frmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIS", "NamaSiswa", "JenisKelamin", "Kelas", "Jurusan", "Email", "Agama", "Telepon", "Alamat"
            }
        ) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        if ("".equals(txtNIS.getText()) || "".equals(txtEmail.getText()) || 
                "".equals(txtJurusan.getText()) || "".equals(txtAgama.getText()) || 
                "".equals(txtAlamat.getText()) || "".equals(txtKelas.getText()) || 
                "".equals(txtNama.getText()) || "".equals(txtTlp.getText())) {
            JOptionPane.showMessageDialog(this, "Harap Lengkapi Data", "Error", JOptionPane.WARNING_MESSAGE);
        } else {
            String JK = "";
            if (rdLaki.isSelected()) {
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        ...
        int baris =tblData.getSelectedRow();
                    ...
                    txtJurusan.setText(tblData.getValueAt(baris, 4).toString());
                    txtEmail.setText(tblData.getValueAt(baris, 5).toString());
                    txtAgama.setText(tblData.getValueAt(baris, 6).toString());
                    txtTlp.setText(tblData.getValueAt(baris, 7).toString());
